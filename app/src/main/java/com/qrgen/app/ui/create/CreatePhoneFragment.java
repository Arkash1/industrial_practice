...
import com.qrgen.app.databinding.FragmentCreatePhoneBinding;
...
public class CreatePhoneFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentCreatePhoneBinding.inflate(inflater, container, false);
    ...
    private void setupUI() {
        ...
        binding.buttonGenerate.setOnClickListener(v -> {
            ...
            try {
                String content = QRContentBuilder.buildPhoneContent(phone);
                viewModel.generateQRCode(content, QRType.PHONE.getValue(), phone);
    ...
    private void observeViewModel() {
        viewModel.getGeneratedQR().observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                ...
                args.putString("type", QRType.PHONE.getValue());
                ...
                Navigation.findNavController(requireView())
                        .navigate(R.id.action_createPhone_to_result, args);
            }
        });
